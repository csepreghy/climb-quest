...
CREATE OR REPLACE FUNCTION public.get_leaderboard()
 RETURNS TABLE(user_id uuid, character_name text, level integer, total_chalk_earned bigint, total_logs integer, bosses_sent integer, strength_sessions integer, board_sessions integer, owned jsonb, equipped jsonb, gender text)
 LANGUAGE sql
